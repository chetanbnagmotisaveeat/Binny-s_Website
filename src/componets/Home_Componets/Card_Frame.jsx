...
const Card_Frame = () => {
  return (
    <ThemeProvider
      ...
      minBreakpoint="xxs"
    >
      <Container fluid className='p-0 m-0 position-relative  w-100 border border-1 border-primary overflow-hidden'>
        <div className='home-main-div-margin-bottom-and-top'>
          <Row className='d-flex flex-column align-items-center background-image'>
            <Col className="text-center mt-3 carft-heading position-relative border border-1 border-parimary" >
              Crafting excellence since 1962
            </Col>

            <Col className="text-center position-relative border border-1 border-parimary">
